...
public class StudentOrderDaoImpl implements StudentOrderDao{
    ...
    private static final String INSERT_ORDER =
          "INSERT INTO public.jc_student_order(" +
                  ...
                  "h_passport_number, h_passport_date, h_passport_office_id," +
                  "h_post_index, h_street_code, h_building, h_extension, " +
                  "h_apartment, h_university_id, h_student_number," +
    ...
    private void setParamsForAddress(PreparedStatement stmt, int start, Person person) throws SQLException {
        Address hAndW_address = person.getAddress();
        stmt.setString(start, hAndW_address.getPostCode());
        stmt.setLong(start + 1, hAndW_address.getStreet().getStreetCode());
        stmt.setString(start + 2, hAndW_address.getBuilding());
        stmt.setString(start + 3, hAndW_address.getExtension());
        stmt.setString(start + 4, hAndW_address.getApartment());
    }
