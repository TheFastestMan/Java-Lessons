...
public class StudentOrderDaoIml implements StudentOrderDao{
    ...
    public Long saveStudentOrder(StudentOrder so) throws DaoException {
        try (Connection con = getConnection();
            ...
            stmt.setString(3, husband.getGivenName());
            stmt.setString(3, husband.getPatronymic());
